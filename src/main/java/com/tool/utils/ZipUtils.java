            ...
            if (listFiles == null || listFiles.length == 0) {
                ...
                for (File file : listFiles) {
                    ...
                    if (keepDirStructure) {
                        ...
                        compress(file, specifiedFolderNames, specifiedFileNames, zos, name + File.separator + file.getName(), keepDirStructure);
                    } else {
                        compress(file, specifiedFolderNames, specifiedFileNames, zos, file.getName(), keepDirStructure);
                    }
                }
            }
        }
